...
import { stakingContractAddressLp } from "../const/wmatic";
import {
  Accordion,
  AccordionItem,
  AccordionButton,
...
export default function Wmatic() {
    ...
    <AccordionItem>
        ...
        <AccordionButton className={styles.menu}>
          <Box className={styles.box} as="span" flex="1" textAlign="left">
            <div className={styles.boxx}>
              <img src="/wmatic.png" width={40} />
              <h3 className={styles.padian}>
                Earn Wmatic <span className={styles.padi}>Stake Rpay</span>
              </h3>
            </div>
            <h4>APR 4.76%</h4>
          </Box>
      ...
      <AccordionPanel pb={4}>
        <div className={styles.now}>
          <h4>
            <span className={styles.ap}>Wmatic</span> Earned
          </h4>
        ...
        <div className={styles.bung}>
          ...
          <div className={styles.foot}>
            ...
            <div className={styles.ass}>
              ...
              <a
                className={styles.ap}
                href="https://polygonscan.com/address/0x3f7232574abe64c7DBe9C79fcE982FceB35da6bE"
              >
                View Contract
              </a>
              <a className={styles.ap} href="https://polygon.technology/">
                View Project
              </a>
            </div>
          </div>
